...
// import { MdEdit, MdArrowBack, MdCheckCircle, MdVerified } from "react-icons/md";
...
// const getRelationName = (relation, nameKeys) => {
//   if (typeof relation === "string") return relation.trim();
//   if (!relation || typeof relation !== "object") return "";

//   return nameKeys.find((key) => relation[key])
//     ? String(relation[nameKeys.find((key) => relation[key])]).trim()
//     : "";
// };

// const getRelationNames = (relations, nameKeys) => {
//   if (!Array.isArray(relations)) return [];

//   return relations
//     .map((relation) => getRelationName(relation, nameKeys))
//     .filter(Boolean);
// };
...
// // ─── Approve button helpers ─────────────────────────────────────
// // A company is considered "Approved" when company_status === "active".
// // Clicking the button toggles between "active" (approved) and "pending" (not approved).
// const isApprovedStatus = (status) => status === "active";
...
//       // Refresh the data to get latest
//       const response = await companyService.getById(id);
//       const data = response?.data || response;
//       if (data) {
//         // Update both viewData and initialData
//         setViewData(data);
//         // Rebuild initialData with the new status
//         setInitialData((prev) => ({
//           ...prev,
...
//     const nextStatus = isApprovedStatus(initialData?.company_status)
//       ? "pending"
//       : "active";
...
//             industry_name:
//               getRelationNames(data.Industries, ["industry_name", "name"])[0] ||
...
//             is_status: getBooleanValue(data.is_status) ? "active" : "inactive",
//             is_trending: getBooleanValue(data.is_trending),
...
//             industries: getRelationNames(data.Industries, [
//               "industry_name",
//               "name",
//             ]),
//             subIndustries: getRelationNames(data.SubIndustries, [
//               "sub_industry_name",
//               "name",
//             ]),
...
//   const approved = isApprovedStatus(initialData.company_status);
...
//                 {viewData.company_name || "Company Details"}
//               </h1>
//             </div>
//           </div>
...
//               className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg shadow-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
//                 approved
...
//             <button
//               onClick={handleEdit}
//               className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-sm transition-colors"
//             >
//               <MdEdit size={18} />
//               Edit Company
//             </button>
...
//                     About Company
//                   </label>
//                   <div className="mt-1 bg-gray-50 p-4 rounded-lg border border-gray-200 max-w-2xl">
//                     {initialData.about_company ? (
//                       <div
//                         className="prose prose-sm max-w-none text-gray-700 [&_a]:text-blue-600 [&_a]:underline [&_img]:rounded-lg [&_table]:border [&_table]:border-gray-300 [&_td]:border [&_td]:border-gray-300 [&_td]:p-2 [&_th]:border [&_th]:border-gray-300 [&_th]:p-2"
...
//                       initialData.industries.map((name, idx) => (
//                         <span
//                           key={idx}
...
//                       initialData.subIndustries.map((name, idx) => (
//                         <span
//                           key={idx}
//                           className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-purple-50 text-purple-700 border border-purple-200"
//                         >
...
//                         }`}
//                       />
//                       {initialData.is_trending ? "Trending" : "Not Trending"}
//                     </span>
//                   </div>
//                 </div>
//               </div>
...
//                     {initialData.profile_completion}/100
//                   </div>
//                 </div>
//                 <div>
//                   <label className="text-xs font-medium text-gray-500 uppercase tracking-wider">
...
//                   <div className="mt-1">
//                     {renderCompletionBar(
//                       initialData.profile_completion_percentage,
//                     )}
//                   </div>
//                 </div>
//                 <div>
