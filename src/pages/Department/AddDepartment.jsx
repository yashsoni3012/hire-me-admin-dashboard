...
//       showError(error.message || error?.response?.data?.message || "Failed to create department");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//       breadcrumb="Create a new department"
//     />
//   );
// };
...
// pages/departments/AddDepartment.jsx
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';
...
const AddDepartment = () => {
  ...
  // ─── Compute hero data ────────────────────────────────────
  const departmentName = formValues.department_name?.trim() || 'New Department';
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex items-center gap-2 flex-wrap">
                  <span className="text-xs text-white/50">New Department</span>
                </div>
              </div>
            </div>
          </div>
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="add-department-tab-underline"
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                      ...
                      <div className="p-6">
                        <p className="text-sm text-slate-500">
                          This department hasn't been created yet. Once created, activity details will appear here.
                        </p>
                      </div>
                    </div>
                  </div>
