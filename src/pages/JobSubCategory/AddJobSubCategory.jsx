...
// const AddJobSubCategory = ({ isOpen, onClose, onSuccess, editData }) => {
...
//       try {
//         const response = await jobCategoryService.getAll({ limit: 100 });
...
//   useEffect(() => {
//     if (editData) {
//       // Get category_id from nested JobCategory object
//       const categoryId = editData.JobCategory?.id || editData.category_id || "";
...
//       console.log("Submitting job sub category data:", submitData);
...
//         showSuccess("Job sub category updated successfully");
//       } else {
//         await jobSubCategoryService.create(submitData);
//         showSuccess("Job sub category created successfully");
//       }
//       onSuccess();
//     } catch (error) {
...
//       const errorMessage =
//         error.message ||
//         `Failed to ${isEdit ? "update" : "create"} job sub category`;
...
//       isOpen={isOpen}
//       onClose={onClose}
//       title={isEdit ? "Edit Job Sub Category" : "Add New Job Sub Category"}
//       size="lg"
//     >
...
//                 {isEdit ? `Edit Job Sub Category` : `Add New Job Sub Category`}
//               </h2>
//               <p className="text-sm text-gray-500">
//                 {isEdit
//                   ? "Update job sub category information"
//                   : "Fill in the details to create a new job sub category"}
//               </p>
//             </div>
//           </div>
//           <button
...
//               placeholder="Enter job sub category name"
//               required
//               error={errors.name}
//               disabled={loading}
//             />
