// // // pages/candidates/CandidatesView.jsx
// // import React, { useState, useEffect } from 'react';
// // import { useNavigate, useLocation, useParams } from 'react-router-dom';
// // import { MdArrowBack, MdPerson, MdEmail, MdPhone, MdCalendarToday, MdUpdate } from 'react-icons/md';
...
// //                     <p className="mt-3 text-gray-500">Loading candidate details...</p>
// //                 </div>
// //             </div>
// //         );
// //     }
...
// //                             <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium ${candidate.status === "active" ? "bg-green-50 text-green-700" : "bg-gray-100 text-gray-500"
// //                                 }`}>
// //                                 <span className={`w-1.5 h-1.5 rounded-full ${candidate.status === "active" ? "bg-green-500" : "bg-gray-400"
// //                                     }`} />
...
// //                                     <img
// //                                         src={getFullImageUrl(candidate.profile_photo)}
// //                                         alt="Profile"
...
// //                                     />
// //                                 ) : (
// //                                     <div className="w-24 h-24 rounded-full bg-[#2c0eee] flex items-center justify-center text-white text-3xl font-bold border-4 border-white shadow-lg">
...
// //                                             Last login: {formatDate(candidate.last_login_at)}
// //                                         </div>
// //                                     )}
// //                                 </div>
// //                             </div>
...
// //                                     First Name
// //                                 </label>
// //                                 <p className="text-sm text-gray-800 font-medium">{candidate.first_name}</p>
// //                             </div>
// //                             <div>
// //                                 <label className="block text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">
// //                                     Last Name
// //                                 </label>
// //                                 <p className="text-sm text-gray-800 font-medium">{candidate.last_name}</p>
// //                             </div>
// //                             <div>
// //                                 <label className="block text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">
// //                                     Email Address
...
// //                                     Status
// //                                 </label>
// //                                 <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ${candidate.status === "active" ? "bg-green-50 text-green-700" : "bg-gray-100 text-gray-500"
// //                                     }`}>
// //                                     <span className={`w-1.5 h-1.5 rounded-full ${candidate.status === "active" ? "bg-green-500" : "bg-gray-400"
// //                                         }`} />
// //                                     {candidate.status === "active" ? "Active" : "Inactive"}
...
// //                                         Last Login
// //                                     </label>
// //                                     <p className="text-sm text-gray-800">{formatDate(candidate.last_login_at)}</p>
// //                                 </div>
// //                             )}
// //                         </div>
// //                     </div>
...
// //                         <h3 className="text-sm font-semibold text-gray-700 mb-4">Audit Information</h3>
// //                         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
// //                             <div>
// //                                 <label className="block text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">
// //                                     Created By
// //                                 </label>
// //                                 <p className="text-sm text-gray-800">{getUserNameCached(candidate.created_by)}</p>
// //                             </div>
// //                             <div>
// //                                 <label className="block text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">
// //                                     Updated By
// //                                 </label>
// //                                 <p className="text-sm text-gray-800">{candidate.updated_by ? getUserNameCached(candidate.updated_by) : "—"}</p>
// //                             </div>
// //                             <div>
// //                                 <label className="block text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">
// //                                     Created At
// //                                 </label>
// //                                 <p className="text-sm text-gray-800">{formatDate(candidate.created_at)}</p>
// //                             </div>
...
// //                                         Updated At
// //                                     </label>
// //                                     <p className="text-sm text-gray-800">{formatDate(candidate.updated_at)}</p>
// //                                 </div>
// //                             )}
// //                         </div>
// //                     </div>
...
//         {Icon && <Icon className="w-5 h-5 text-[#2c0eee]" />}
...
//   <div
//     className={`flex flex-col sm:flex-row sm:items-center py-3 border-b border-gray-100 last:border-0 ${className}`}
//   >
//     <span className="text-xs font-medium text-gray-500 uppercase tracking-wider sm:w-36 flex-shrink-0">
//       {label}
//     </span>
...
//   // Fetch full candidate profile from the API
//   useEffect(() => {
//     const fetchData = async () => {
//       if (!id) return;
//       setLoading(true);
//       try {
//         // Use the new getFullProfile method
...
//   // Calculate total experience from candidate_experience
...
//           <p className="mt-3 text-gray-500">Loading candidate profile...</p>
//         </div>
//       </div>
//     );
//   }
...
//                 <div className="h-24 bg-gradient-to-r from-[#2c0eee] to-[#6c5ce7]" />
...
//                       />
//                     ) : (
//                       <div className="w-28 h-28 rounded-full border-4 border-white shadow-lg bg-gradient-to-br from-[#2c0eee] to-[#6c5ce7] flex items-center justify-center text-white text-3xl font-bold">
//                         {candidate?.first_name?.[0]?.toUpperCase() || "?"}
//                         {candidate?.last_name?.[0]?.toUpperCase() || ""}
//                       </div>
//                     )}
...
//                   <p className="text-sm text-[#2c0eee] font-medium mt-1">
//                     {candidate_profiles.headline}
//                   </p>
//                 )}
...
//                       <MdEmail size={14} /> {candidate.email}
//                     </span>
//                   )}
//                 </div>
//                 {candidate?.mobile && (
//                   <div className="flex items-center justify-center gap-1 mt-1 text-sm text-gray-500">
//                     <MdPhone size={14} /> {candidate.mobile}
//                   </div>
//                 )}
//                 {candidate_profiles?.City?.name && (
//                   <div className="flex items-center justify-center gap-1 mt-1 text-sm text-gray-500">
//                     <MdLocationOn size={14} /> {candidate_profiles.City.name}
//                   </div>
//                 )}
...
//                       <MdPerson size={12} />{" "}
//                       {candidate_profiles.gender.charAt(0).toUpperCase() +
//                         candidate_profiles.gender.slice(1)}
//                     </span>
//                   )}
...
//                         .charAt(0)
//                         .toUpperCase() +
//                         candidate_profiles.marital_status.slice(1)}
//                     </span>
//                   )}
...
//               undefined && (
//               <Section title="Profile Completion" icon={MdStar}>
...
//             {/* Quick Stats */}
//             <Section title="Quick Stats" icon={MdTrendingUp}>
//               <div className="grid grid-cols-2 gap-4">
//                 {totalExperience && (
//                   <div className="text-center p-3 bg-gray-50 rounded-lg">
//                     <p className="text-2xl font-bold text-[#2c0eee]">
//                       {totalExperience}
//                     </p>
...
//             {/* Resume */}
//             {candidate_resumes && candidate_resumes.resume_file && (
//               <Section title="Resume" icon={MdDescription}>
//                 <a
...
//               <Section title="Social Links" icon={MdLink}>
//                 <div className="space-y-2">
//                   {candidate_social_links.map((link, idx) => (
//                     <a
//                       key={idx}
//                       href={
//                         link.social_url?.startsWith("http")
//                           ? link.social_url
//                           : `https://${link.social_url}`
//                       }
//                       target="_blank"
//                       rel="noopener noreferrer"
//                       className="flex items-center gap-2 text-[#2c0eee] hover:underline text-sm"
//                     >
//                       <MdLink size={14} />
//                       {link.social_type?.charAt(0).toUpperCase() +
//                         link.social_type?.slice(1)}
//                       : {link.social_url}
//                     </a>
//                   ))}
//                 </div>
...
//                 <InfoRow
//                   label="Nationality"
//                   value={candidate_profiles?.nationality}
//                 />
//                 <InfoRow
//                   label="Date of Birth"
//                   value={
//                     candidate_profiles?.dob
//                       ? formatDate(candidate_profiles.dob)
//                       : "—"
//                   }
//                 />
//                 <InfoRow
//                   label="Current City"
//                   value={candidate_profiles?.City?.name || "—"}
//                 />
//                 <InfoRow
//                   label="Current Address"
//                   value={candidate_profiles?.current_address || "—"}
//                 />
//                 <InfoRow
//                   label="Pincode"
//                   value={candidate_profiles?.pincode || "—"}
//                 />
//                 <InfoRow
//                   label="Willing to Relocate"
//                   value={candidate_profiles?.willing_to_relocate ? "Yes" : "No"}
//                 />
//                 <InfoRow
//                   label="Notice Period"
//                   value={candidate_profiles?.NoticePeriod?.name || "—"}
//                 />
//                 <InfoRow
...
//             {/* Skills */}
//             {candidate_skills && candidate_skills.length > 0 && (
//               <Section title="Skills" icon={MdWork}>
//                 <TagList
//                   items={candidate_skills.map(
//                     (s) => s.Skill?.skill_name || s.skill_id,
//                   )}
//                   color="blue"
//                 />
//               </Section>
...
//             {/* Work Experience */}
//             {candidate_experience && candidate_experience.length > 0 && (
//               <Section title="Work Experience" icon={MdBusiness}>
//                 <div className="space-y-6">
//                   {candidate_experience.map((exp, idx) => (
//                     <div
//                       key={idx}
//                       className={`pb-6 ${idx < candidate_experience.length - 1 ? "border-b border-gray-200" : ""}`}
//                     >
//                       <div className="flex flex-wrap items-start justify-between gap-2">
//                         <div>
//                           <h3 className="text-base font-semibold text-gray-900">
//                             {exp.job_title || exp.designation}
//                           </h3>
...
//                           <span className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded">
//                             Workplace: {exp.WorkplaceType.name}
//                           </span>
//                         )}
//                         {exp.jobType?.name && (
//                           <span className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded">
//                             Job Type: {exp.jobType.name}
//                           </span>
//                         )}
//                         {exp.salary && (
//                           <span className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded">
//                             Salary: ₹{parseFloat(exp.salary).toLocaleString()}
//                           </span>
//                         )}
//                       </div>
//                       {exp.job_description && (
...
//                     <div
//                       key={idx}
//                       className={`pb-6 ${idx < candidate_education.length - 1 ? "border-b border-gray-200" : ""}`}
//                     >
//                       <div className="flex flex-wrap items-start justify-between gap-2">
//                         <div>
//                           <h3 className="text-base font-semibold text-gray-900">
//                             {edu.EducationSubCategory?.name || "Education"}
//                           </h3>
...
//                           <span className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded">
//                             Category: {edu.EducationCategory.name}
//                           </span>
//                         )}
//                         {edu.percentage && (
//                           <span className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded">
...
//             {/* Job Preferences */}
//             {candidate_preferences && (
//               <Section title="Job Preferences" icon={MdWork}>
//                 <div className="space-y-4">
//                   {candidate_preferences.preferred_salary && (
//                     <InfoRow
//                       label="Preferred Salary"
//                       value={`₹${parseFloat(candidate_preferences.preferred_salary).toLocaleString()}`}
//                     />
//                   )}
...
//                         <div className="mt-2">
//                           <TagList
//                             items={candidate_preferences.preferred_industries.map(
//                               (i) => i.name,
//                             )}
//                             color="green"
//                           />
...
//                       </div>
//                     )}
//                   {candidate_preferences.preferred_cities &&
...
//                         <div className="mt-2">
//                           <TagList
//                             items={candidate_preferences.preferred_cities.map(
//                               (c) => c.name,
//                             )}
//                             color="purple"
//                           />
...
//                       </div>
//                     )}
//                   {candidate_preferences.preferred_workplace_types &&
//                     candidate_preferences.preferred_workplace_types.length >
//                       0 && (
//                       <div>
//                         <span className="text-xs font-medium text-gray-500 uppercase tracking-wider">
...
//                         <div className="mt-2">
//                           <TagList
//                             items={candidate_preferences.preferred_workplace_types.map(
//                               (w) => w.name,
//                             )}
//                             color="amber"
//                           />
...
//             {/* Certifications */}
//             {candidate_certification && candidate_certification.length > 0 && (
//               <Section title="Certifications" icon={MdVerified}>
//                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
...
//             {/* Projects */}
//             {candidate_projects && candidate_projects.length > 0 && (
//               <Section title="Projects" icon={MdBook}>
//                 <div className="space-y-6">
//                   {candidate_projects.map((project, idx) => (
//                     <div
//                       key={idx}
//                       className={`pb-6 ${idx < candidate_projects.length - 1 ? "border-b border-gray-200" : ""}`}
//                     >
//                       <div className="flex flex-wrap items-start justify-between gap-2">
//                         <div>
//                           <h3 className="text-base font-semibold text-gray-900">
...
//                           target="_blank"
//                           rel="noopener noreferrer"
//                           className="inline-block mt-2 text-[#2c0eee] hover:underline text-sm"
//                         >
//                           View Project →
//                         </a>
//                       )}
...
//             {/* Awards */}
//             {candidate_awards && candidate_awards.length > 0 && (
//               <Section title="Awards" icon={MdEmojiEvents}>
//                 <div className="space-y-3">
...
//             {/* Audit Information */}
//             <Section title="Audit Information" icon={MdCalendarToday}>
//               <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                 <InfoRow
//                   label="Created By"
//                   value={
//                     candidate?.created_by
//                       ? getUserNameCached(candidate.created_by)
//                       : "System"
//                   }
//                 />
//                 <InfoRow
...
//                       ? getUserNameCached(candidate.updated_by)
//                       : "—"
//                   }
//                 />
//                 <InfoRow
...
//                       ? formatDate(candidate_profiles.updated_at)
//                       : "—"
//                   }
//                 />
//               </div>
