...
//       help: "Trending skills will be highlighted",
//     },
//   ];
...
//     skill_name: {
//       required: true,
//       requiredMessage: "Skill name is required",
//       minLength: 2,
//       minLengthMessage: "Skill name must be at least 2 characters",
//       maxLength: 100,
//       maxLengthMessage: "Skill name must be at most 100 characters",
//     },
//   };
...
//       showError(error.message || error?.response?.data?.message || "Failed to create skill");
//     } finally {
//       setLoading(false);
//     }
//   };
...
const AddSkill = () => {
  ...
  const validateField = (name, value) => {
    if (name === 'skill_name') {
      ...
      if (value.trim().length > 100) return 'Skill name must be at most 100 characters';
    }
    return null;
  };
  ...
  const validateForm = () => {
    ...
    const error = validateField('skill_name', formValues.skill_name);
    if (error) {
      newErrors.skill_name = error;
      isValid = false;
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        skill_name: formValues.skill_name.trim(),
  ...
  // ─── Compute hero data ────────────────────────────────────
  const skillName = formValues.skill_name?.trim() || 'New Skill';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-[11px] text-slate-400 leading-tight">Skills</p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex items-center gap-2 flex-wrap">
                  <span className="text-xs text-white/50">New Skill</span>
                </div>
              </div>
            </div>
          </div>
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="add-skill-tab-underline"
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                      ...
                      <div className="p-6">
                        <p className="text-sm text-slate-500">
                          This skill hasn't been created yet. Once created, activity details will appear here.
                        </p>
                      </div>
                    </div>
                  </div>
