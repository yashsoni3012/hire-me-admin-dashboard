...
//     return userNameCache[key] || `${userId}`;
//   };
...
//             created_by: getCreatedByName(data),
//             updated_by: getUpdatedByName(data),
...
//       type: "text",
//       readonly: true,
//       viewRender: (value) => value ? formatDateFromAPI(value) : "—",
//     },
//     {
//       name: "updated_at",
//       label: "Updated At",
...
//       onEdit={handleEdit}
//       navigateTo="/skills"
//       breadcrumb={`Viewing: ${viewData?.skill_name || 'Skill'}`}
//       enableEditMode={true}
//       showEdit={true}
...
const ViewSkill = () => {
  ...
  // ─── Compute hero data ────────────────────────────────────
  const skillName = skillData.skill_name || 'Skill';
  const status = skillData.status || 'inactive';
  const isTrending = skillData.is_trending || false;
  const createdDate = skillData.created_at ? formatDateFromAPI(skillData.created_at) : '—';
  const updatedDate = skillData.updated_at ? formatDateFromAPI(skillData.updated_at) : '—';
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <ReadOnlyValue>
                  <span className="font-medium text-lg">{skillName}</span>
                </ReadOnlyValue>
              </div>
              <div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="p-6 space-y-5">
                <div>
                  ...
                  <ReadOnlyValue>
                    {skillData.created_by ? getUserNameCached(skillData.created_by) : '—'}
                  </ReadOnlyValue>
                </div>
                <div>
                ...
                <div>
                  ...
                  <ReadOnlyValue>
                    {skillData.updated_by ? getUserNameCached(skillData.updated_by) : '—'}
                  </ReadOnlyValue>
                </div>
                <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex items-center gap-2 flex-wrap">
                  <span className="text-xs text-white/70">ID: #{skillData.id}</span>
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="view-skill-tab-underline"
