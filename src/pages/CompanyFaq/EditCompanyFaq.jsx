...
//       try {
//         const response = await companyFaqService.getById(id);
...
//         } else {
//           showError("Company FAQ not found");
//           navigate('/company-faq');
//         }
//       } catch (error) {
//         console.error('Fetch error:', error);
//         showError(error.message || "Failed to load Company FAQ data");
//         navigate('/company-faq');
//       } finally {
...
//       await companyFaqService.update(id, submitData);
//       showSuccess("Company FAQ updated successfully");
//       navigate('/company-faq');
//     } catch (error) {
//       console.error('Submit error:', error);
//       showError(error.message || error?.response?.data?.message || "Failed to update Company FAQ");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//     try {
//       await companyFaqService.delete(id);
//       showSuccess("Company FAQ deleted successfully");
//       navigate('/company-faq');
//     } catch (error) {
//       console.error('Delete error:', error);
//       showError(error.message || "Failed to delete Company FAQ");
//     } finally {
...
//           <p className="text-sm text-gray-400">Loading Company FAQ data...</p>
//         </div>
//       </div>
//     );
//   }
...
//       breadcrumb={`Editing: ${editItem?.question || 'Company FAQ'}`}
//       showEdit={false}
//     />
//   );
// };
...
const EditCompanyFaq = () => {
  ...
  // ─── Hero helpers ──────────────────────────────────────────────
  const heroQuestion = formValues.question?.trim() || "Company FAQ";
  const initials = "FAQ";
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="edit-company-faq-tab-underline"
