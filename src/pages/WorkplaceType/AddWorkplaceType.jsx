// // pages/workplace-types/AddWorkplaceType.jsx
...
//       await workplaceTypeService.create(submitData);
//       showSuccess("Workplace type created successfully");
      
//       navigate('/workplace-types');
//     } catch (error) {
//       console.error('Submit error:', error);
//       showError(error.message || error?.response?.data?.message || "Failed to create workplace type");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//       breadcrumb="Create a new workplace type"
//     />
//   );
// };

// export default AddWorkplaceType;
...
const AddWorkplaceType = () => {
  ...
  const validateField = (name, value) => {
    if (name === 'name') {
      if (!value || !value.trim()) return 'Workplace type name is required';
      if (value.trim().length < 2) return 'Workplace type name must be at least 2 characters';
      if (value.trim().length > 100) return 'Workplace type name must be at most 100 characters';
    }
    return null;
  };
  ...
  // ─── Compute hero data ────────────────────────────────────
  const workplaceName = formValues.name?.trim() || 'New Workplace Type';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            >
              ...
              {loading ? 'Creating...' : 'Create Workplace Type'}
            </button>
          </div>
        </div>
      </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex items-center gap-2 flex-wrap">
                  <span className="text-xs text-white/50">New Workplace Type</span>
                </div>
              </div>
            </div>
          </div>
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="add-workplace-type-tab-underline"
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                      ...
                      <div className="p-6">
                        <p className="text-sm text-slate-500">
                          This workplace type hasn't been created yet. Once created, activity details will appear here.
                        </p>
                      </div>
                    </div>
                  </div>
