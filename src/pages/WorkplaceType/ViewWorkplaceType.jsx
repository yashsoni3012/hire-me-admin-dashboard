...
//   const handleEdit = () => {
//     navigate(`/workplace-types/edit/${id}`);
//   };
...
//           <p className="text-sm text-gray-400">Loading workplace type details...</p>
//         </div>
//       </div>
//     );
//   }
...
//       breadcrumb={`Viewing: ${viewData?.name || 'Workplace Type'}`}
//       enableEditMode={true}
//       showEdit={true}
//       editLabel="Edit Workplace Type"
//       cancelLabel="Back to Workplace Types"
//     />
//   );
// };

// export default ViewWorkplaceType;

// pages/workplace-types/ViewWorkplaceType.jsx
import React, { useState, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
...
const ViewWorkplaceType = () => {
  ...
  const handleBack = () => navigate('/workplace-types');
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-[#F4F5FA]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-slate-400">Loading workplace type details...</p>
        </div>
      </div>
    );
  }
  ...
  // ─── Compute hero data ────────────────────────────────────
  const workplaceName = workplaceData.name || 'Workplace Type';
  const status = workplaceData.status || 'inactive';
  const isTrending = workplaceData.is_trending || false;
  const createdDate = workplaceData.created_at ? formatDate(workplaceData.created_at) : '—';
  const updatedDate = workplaceData.updated_at ? formatDate(workplaceData.updated_at) : '—';

  const initials = workplaceName
    .split(' ')
    .filter(Boolean)
    .slice(0, 2)
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <ReadOnlyValue>
                  <span className="font-medium text-lg">{workplaceName}</span>
                </ReadOnlyValue>
              </div>
              <div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="p-6 space-y-5">
                <div>
                  ...
                  <ReadOnlyValue>
                    {workplaceData.created_by
                      ? getUserNameCached(workplaceData.created_by)
                      : '—'}
                  </ReadOnlyValue>
                </div>
                <div>
                ...
                <div>
                  ...
                  <ReadOnlyValue>
                    {workplaceData.updated_by
                      ? getUserNameCached(workplaceData.updated_by)
                      : '—'}
                  </ReadOnlyValue>
                </div>
                <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-[11px] text-slate-400 leading-tight">Workplace Types</p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex items-center gap-2 flex-wrap">
                  <span className="text-xs text-white/70">ID: #{workplaceData.id}</span>
                  {workplaceData.created_at && (
                    <>
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="view-workplace-type-tab-underline"
