// // pages/billing-rates/AddBillingRate.jsx
...
//     setLoading(true);
//     try {
//       // ─── Parse display_order - ensure default 0 ──────────────
//       let displayOrder = 0;
//       if (formData.display_order !== undefined && formData.display_order !== null && formData.display_order !== '') {
//         displayOrder = parseInt(formData.display_order) || 0;
//       }

//       const submitData = {
//         display_text: formData.display_text.trim(),
//         amount: parseFloat(formData.amount) || 0,
//         display_order: displayOrder, // ─── Always send 0 if not provided ──
//         status: formData.status === "active",
//       };

//       console.log('Submitting billing rate data:', submitData);
//       await billingRateService.create(submitData);
//       showSuccess("Billing rate created successfully");
      
//       navigate('/billing-rates');
//     } catch (error) {
//       console.error('Submit error:', error);
//       showError(error.message || error?.response?.data?.message || "Failed to create billing rate");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//       breadcrumb="Create a new billing rate"
//     />
//   );
// };

// export default AddBillingRate;
...
const AddBillingRate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let displayOrder = 0;
      if (formValues.display_order !== undefined && formValues.display_order !== null && formValues.display_order !== '') {
        displayOrder = parseInt(formValues.display_order) || 0;
      }
  ...
  // ─── Compute hero data ────────────────────────────────────
  const displayText = formValues.display_text?.trim() || 'New Billing Rate';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            >
              ...
              {loading ? 'Creating...' : 'Create Billing Rate'}
            </button>
          </div>
        </div>
      </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex items-center gap-2 flex-wrap">
                  ...
                  <span className="text-xs text-white/50">New Billing Rate</span>
                </div>
              </div>
            </div>
          </div>
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="add-billing-rate-tab-underline"
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                      ...
                      <div className="p-6">
                        <p className="text-sm text-slate-500">
                          This billing rate hasn't been created yet. Once created, activity details will appear here.
                        </p>
                      </div>
                    </div>
                  </div>
