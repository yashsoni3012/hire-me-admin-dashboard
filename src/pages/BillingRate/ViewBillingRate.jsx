// // pages/billing-rates/ViewBillingRate.jsx
...
//         if (data && data.id) {
//           // ─── FIX: Determine status from status field ────────────
//           let isActive = false;
...
//   const handleEdit = () => {
//     navigate(`/billing-rates/edit/${id}`);
//   };
...
//           <p className="text-sm text-gray-400">Loading billing rate details...</p>
//         </div>
//       </div>
//     );
//   }
...
//       breadcrumb={`Viewing: ${viewData?.display_text || 'Billing Rate'}`}
//       enableEditMode={true}
//       showEdit={true}
//       editLabel="Edit Billing Rate"
//       cancelLabel="Back to Billing Rates"
//     />
//   );
// };

// export default ViewBillingRate;
...
const ViewBillingRate = () => {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-[#F4F5FA]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-slate-400">Loading billing rate details...</p>
        </div>
      </div>
    );
  }
  ...
  // ─── Compute hero data ────────────────────────────────────
  const displayText = billingData.display_text || 'Billing Rate';
  const amount = billingData.amount || 0;
  const formattedAmount = formatCurrency(amount);
  const status = billingData.status || 'inactive';
  const displayOrder = billingData.display_order ?? 0;
  const createdDate = billingData.created_at ? formatDateTime(billingData.created_at) : '—';
  const updatedDate = billingData.updated_at ? formatDateTime(billingData.updated_at) : '—';
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <ReadOnlyValue>
                  <span className="font-semibold text-slate-900 text-lg">{formattedAmount}</span>
                </ReadOnlyValue>
              </div>
              <div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="p-6 space-y-5">
                <div>
                  ...
                  <ReadOnlyValue>
                    {billingData.created_by ? getUserNameCached(billingData.created_by) : '—'}
                  </ReadOnlyValue>
                </div>
                <div>
                ...
                <div>
                  ...
                  <ReadOnlyValue>
                    {billingData.updated_by ? getUserNameCached(billingData.updated_by) : '—'}
                  </ReadOnlyValue>
                </div>
                <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex items-center gap-2 flex-wrap">
                  <span className="text-xs text-white/70">Amount: {formattedAmount}</span>
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="view-billing-rate-tab-underline"
