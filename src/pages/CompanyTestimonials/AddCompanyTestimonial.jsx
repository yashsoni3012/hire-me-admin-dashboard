// // pages/AddCompanyTestimonial.jsx
...
//       accept: "image/*",
//       maxSize: 5,
//       help: "Upload a photo of the client (JPG, PNG, WebP)",
//     },
//     {
//       name: "status",
//       label: "Status",
...
//       // IMPORTANT: Check for image file from FormPage
//       if (formData.imageFile instanceof File) {
//         submitData.imageFile = formData.imageFile;
//         console.log('📸 Image file found:', formData.imageFile.name);
//       }

//       await companyTestimonialService.create(submitData);
...
//       breadcrumb="Create a new testimonial"
//     />
//   );
// };

// export default AddCompanyTestimonial;

// pages/company-testimonials/AddCompanyTestimonial.jsx
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';
...
const AddCompanyTestimonial = () => {
  ...
  // ─── Compute hero data ────────────────────────────────────
  const clientName = formValues.name?.trim() || 'New Testimonial';
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="add-testimonial-tab-underline"
