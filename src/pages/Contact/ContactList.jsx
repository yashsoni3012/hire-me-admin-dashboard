...
// //                                 className="text-sm border border-gray-200 rounded-lg px-3 py-1.5 bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-purple-100 focus:border-purple-300"
// //                             >
...
// //                                     className={`flex items-center gap-1 font-medium transition-colors ${statusFilter === status ? "text-purple-600" : "text-gray-500 hover:text-gray-700"
// //                                         }`}
// //                                 >
...
//             const userName = user?.name || user?.username || `Admin ${userId}`;
//             showSuccess(`Task assigned to ${userName} successfully`);
//             setDropdownOpen(null);
//             loadData();
//         } catch (error) {
...
//             showError(error.message || "Failed to unassign task");
//         }
//     };
...
//         const colors = ['#4F46E5', '#059669', '#D97706', '#7C3AED', '#DC2626', '#2563EB', '#D946EF'];
...
//         useEffect(() => {
//             dropdownRefs.current[contactId] = ref.current;
//         }, [contactId]);

//         const currentUser = users.find(u => u.id === currentAssignedTo || u._id === currentAssignedTo);
...
//                 <button
//                     onClick={() => setDropdownOpen(isOpen ? null : contactId)}
//                     className={`
...
//                 {isOpen && (
//                     <div className="absolute left-0 mt-2 w-64 bg-white rounded-xl shadow-2xl border border-gray-100 z-50 overflow-hidden animate-dropdown">
...
//                             ) : (
//                                 users.map((user) => {
//                                     const isSelected = currentAssignedTo === user.id || currentAssignedTo === user._id;
...
//                                             className={`
//                         w-full px-4 py-2.5 flex items-center gap-3 hover:bg-gray-50 transition-all duration-150
