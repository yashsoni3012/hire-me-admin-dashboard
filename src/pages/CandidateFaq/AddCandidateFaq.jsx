...
//       await candidateFaqService.create(submitData);
//       showSuccess("FAQ created successfully");
//       navigate('/candidate-faq');
//     } catch (error) {
//       console.error('Submit error:', error);
//       showError(error.message || error?.response?.data?.message || "Failed to create FAQ");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//       breadcrumb="Create a new FAQ"
//     />
//   );
// };

// export default AddCandidateFaq;

// pages/candidate-faq/AddCandidateFaq.jsx
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';
...
const AddCandidateFaq = () => {
  ...
  // ─── Compute hero data ────────────────────────────────────
  const question = formValues.question?.trim() || 'New Candidate FAQ';
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="add-candidate-faq-tab-underline"
