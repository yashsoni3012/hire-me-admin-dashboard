...
//       const response = await fetch(`${API_BASE}/company-types`, {
//         method: "POST",
//         headers: {
...
//       showError(error.message || "Failed to create company type");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//       breadcrumb="Create a new company type"
//     />
//   );
// };
...
// pages/company-types/AddCompanyType.jsx
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';
...
const AddCompanyType = () => {
  ...
  // ─── Compute hero data ────────────────────────────────────
  const companyTypeName = formValues.name?.trim() || 'New Company Type';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            >
              ...
              {loading ? 'Creating...' : 'Create Company Type'}
            </button>
          </div>
        </div>
      </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex items-center gap-2 flex-wrap">
                  <span className="text-xs text-white/50">New Company Type</span>
                </div>
              </div>
            </div>
          </div>
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="add-company-type-tab-underline"
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                      ...
                      <div className="p-6">
                        <p className="text-sm text-slate-500">
                          This company type hasn't been created yet. Once created, activity details will appear here.
                        </p>
                      </div>
                    </div>
                  </div>
