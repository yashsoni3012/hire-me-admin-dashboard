// // pages/subscription-coupons/EditSubscriptionCoupon.jsx
...
//             per_company_limit: data.per_company_limit?.toString() || "1",
...
//   // ─── Validation rules (removed per_company_limit validation) ──
...
//       },
//     },
//     // ─── REMOVED: per_company_limit validation ──────────────────
//     // per_company_limit: {
//     //   required: false,
//     //   min: 1,
//     //   minMessage: "Per company limit must be at least 1",
//     //   custom: (value) => {
//     //     if (value && value.trim() !== "") {
//     //       const numValue = parseInt(value);
//     //       if (isNaN(numValue) || numValue < 1) {
//     //         return "Please enter a valid per company limit";
//     //       }
//     //     }
//     //     return null;
//     //   },
...
//       console.log('Updating coupon data:', submitData);
//       await subscriptionCouponService.update(id, submitData);
//       showSuccess("Coupon updated successfully");
      
//       navigate('/subscription-coupons');
//     } catch (error) {
//       console.error('Submit error:', error);
//       showError(error.message || error?.response?.data?.message || "Failed to update coupon");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//     try {
//       await subscriptionCouponService.delete(id);
...
//           <p className="text-sm text-gray-400">Loading coupon data...</p>
//         </div>
//       </div>
//     );
//   }
...
//       breadcrumb={`Editing: ${editItem?.coupon_code || 'Coupon'}`}
//       showEdit={false}
//     />
//   );
// };

// export default EditSubscriptionCoupon;
      ...
      try {
        ...
        if (coupon && coupon.id) {
          ...
          if (coupon.is_status !== undefined && coupon.is_status !== null) {
            isActive = coupon.is_status === true || coupon.is_status === 1 || coupon.is_status === '1' || coupon.is_status === 'true';
          } else if (coupon.status !== undefined && coupon.status !== null) {
            isActive = coupon.status === true || coupon.status === 1 || coupon.status === '1' || coupon.status === 'true' || coupon.status === 'active';
          }
          ...
          const formData = {
            ...
            per_company_limit: coupon.per_company_limit?.toString() || '1',
            is_trending: coupon.is_trending === true || coupon.is_trending === 1 || coupon.is_trending === '1',
            status: isActive ? 'active' : 'inactive',
          };
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-[#F4F5FA]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-slate-400">Loading coupon data...</p>
        </div>
      </div>
    );
  }
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="edit-coupon-tab-underline"
                ...
                {activeTab === 'activity' && (
                  <div className="space-y-6 max-w-xl">
                    <div>
                      ...
                      <ReadOnlyValue>
                        {data?.created_by ? (userNameCache[data.created_by] || `User ${data.created_by}`) : '—'}
                      </ReadOnlyValue>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <ReadOnlyValue>
                        {data?.updated_by ? (userNameCache[data.updated_by] || `User ${data.updated_by}`) : '—'}
                      </ReadOnlyValue>
                    </div>
                    <div>
            ...
            >
              <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100">
                <div className="flex items-center gap-2.5">
                  ...
                  <h3 className="text-base font-semibold text-slate-800">Delete Coupon?</h3>
                </div>
                <button
              ...
              <div className="px-5 py-4">
                <p className="text-sm text-slate-600">
                  This will permanently remove <span className="font-medium text-slate-800">{couponCode}</span> and its data. This action cannot be undone.
                </p>
              </div>
