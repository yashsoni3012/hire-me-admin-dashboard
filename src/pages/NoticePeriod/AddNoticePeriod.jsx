...
//       const response = await fetch(`${API_BASE}/notice-periods`, {
//         method: "POST",
//         headers: {
...
//       showSuccess("Notice period created successfully");
//       navigate('/notice-periods');
//     } catch (error) {
//       console.error('Submit error:', error);
//       showError(error.message || "Failed to create notice period");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//       breadcrumb="Create a new notice period"
//     />
//   );
// };
...
// pages/notice-periods/AddNoticePeriod.jsx
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';
...
const AddNoticePeriod = () => {
  ...
  // ─── Compute hero data ────────────────────────────────────
  const noticePeriodName = formValues.name?.trim() || 'New Notice Period';
  ...
  const initials = noticePeriodName
    .split(' ')
    .filter(Boolean)
    .slice(0, 2)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            >
              ...
              {loading ? 'Creating...' : 'Create Notice Period'}
            </button>
          </div>
        </div>
      </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex items-center gap-2 flex-wrap">
                  ...
                  <span className="text-xs text-white/50">New Notice Period</span>
                </div>
              </div>
            </div>
          </div>
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="add-notice-period-tab-underline"
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                      ...
                      <div className="p-6">
                        <p className="text-sm text-slate-500">
                          This notice period hasn't been created yet. Once created, activity details will appear here.
                        </p>
                      </div>
                    </div>
                  </div>
