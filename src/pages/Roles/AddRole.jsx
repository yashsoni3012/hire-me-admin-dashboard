...
//       showError(error.message || error?.response?.data?.message || "Failed to create role");
//     } finally {
//       setLoading(false);
//     }
//   };
...
const AddRole = () => {
  ...
  const validateField = (name, value) => {
    if (name === 'role_name') {
      ...
      if (value.trim().length > 50) return 'Role name must be at most 50 characters';
      if (!/^[a-zA-Z0-9\s_\-]+$/.test(value.trim())) {
  ...
  const validateForm = () => {
    ...
    const error = validateField('role_name', formValues.role_name);
    if (error) {
      newErrors.role_name = error;
      isValid = false;
    }
  ...
  // ─── Compute hero data ────────────────────────────────────
  const roleName = formValues.role_name?.trim() || 'New Role';
    ...
    <div className="min-h-screen pb-16 bg-[#F4F5FA]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-[11px] text-slate-400 leading-tight">Roles</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex items-center gap-2 flex-wrap">
                  <span className="text-xs text-white/50">New Role</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mt-4">
          ...
          <div className="flex items-center gap-2.5 rounded-xl bg-white/80 backdrop-blur-sm px-3.5 py-2.5 border border-slate-200 shadow-sm">
            <MdSecurity size={16} className="text-slate-400 flex-shrink-0" />
            <div className="min-w-0">
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="add-role-tab-underline"
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                      ...
                      <div className="p-6">
                        <p className="text-sm text-slate-500">
                          This role hasn't been created yet. Once created, activity details will appear here.
                        </p>
                      </div>
                    </div>
                  </div>
