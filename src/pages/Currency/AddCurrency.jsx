// // pages/currencies/AddCurrency.jsx
...
//         // ─── is_default is sent from form but will be set to 0 in service ──
//         is_default: formData.is_default || false,
//         status: formData.status === "active",
//       };

//       console.log('Submitting currency data:', submitData);
//       await currencyService.create(submitData);
//       showSuccess("Currency created successfully");
      
//       navigate('/currencies');
//     } catch (error) {
//       console.error('Submit error:', error);
//       showError(error.message || error?.response?.data?.message || "Failed to create currency");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//       breadcrumb="Create a new currency"
//     />
//   );
// };
...
const AddCurrency = () => {
  ...
  // ─── Compute hero data ────────────────────────────────────
  const currencyName = formValues.currency_name?.trim() || 'New Currency';
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex items-center gap-2 flex-wrap">
                  ...
                  <span className="text-xs text-white/50">New Currency</span>
                </div>
              </div>
            </div>
          </div>
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="add-currency-tab-underline"
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                      ...
                      <div className="p-6">
                        <p className="text-sm text-slate-500">
                          This currency hasn't been created yet. Once created, activity details will appear here.
                        </p>
                      </div>
                    </div>
                  </div>
