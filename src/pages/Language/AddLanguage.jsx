...
//       await languageService.create(submitData);
...
//       showError(error.message || error?.response?.data?.message || "Failed to create language");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//       breadcrumb="Create a new language"
//     />
//   );
// };
...
// pages/languages/AddLanguage.jsx
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';
...
const AddLanguage = () => {
  ...
  // ─── Compute hero data ────────────────────────────────────
  const languageName = formValues.language_name?.trim() || 'New Language';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex items-center gap-2 flex-wrap">
                  <span className="text-xs text-white/50">New Language</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mt-4">
          ...
          <div className="flex items-center gap-2.5 rounded-xl bg-white/80 backdrop-blur-sm px-3.5 py-2.5 border border-slate-200 shadow-sm">
            ...
            <div className="min-w-0">
              <p className="text-[10px] text-slate-500 leading-tight">Active</p>
              <p className="text-sm font-semibold text-slate-700 truncate">
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <motion.span
                      layoutId="add-language-tab-underline"
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                      ...
                      <div className="p-6">
                        <p className="text-sm text-slate-500">
                          This language hasn't been created yet. Once created, activity details will appear here.
                        </p>
                      </div>
                    </div>
                  </div>
